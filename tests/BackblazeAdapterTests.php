...
namespace ElGovanni\Flysystem\Tests;

use BackblazeB2\Client;
use BackblazeB2\File;
use InvalidArgumentException;
use League\Flysystem\Config;
use ElGovanni\Flysystem\BackblazeAdapter as Backblaze;
...
{
    private vfsStreamDirectory $fs_mock;

    private vfsStreamFile $file_mock;
    ...
    public function backblazeProvider(): array
    {
